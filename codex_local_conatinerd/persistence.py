    ...
    try:
        ...
        return DockerRunnerConfig(
            ...
            container_settings_preflight_path=str(
                payload.get("container_settings_preflight_path") or "/tmp/codex-preflight-settings-{task_id}.sh"
            ),
            container_environment_preflight_path=str(
                payload.get("container_environment_preflight_path") or "/tmp/codex-preflight-environment-{task_id}.sh"
            ),
            env_vars=env_vars,
