    ...
    try:
        ...
        on_log(
            format_log(
                ...
                "image",
                "INFO",
                f"checking for cached desktop image: {cached_image_tag}",
            )
        )
        ...
        on_log(
            format_log(
                ...
                "image",
                "INFO",
                "falling back to runtime desktop installation",
            )
        )
        logger.exception(
            format_log(
                ...
                "image",
                "ERROR",
                "Failed to build desktop image, falling back to runtime install",
            )
        )
        return base_image
