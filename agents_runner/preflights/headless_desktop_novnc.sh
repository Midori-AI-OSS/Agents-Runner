...
echo "[desktop/setup][INFO] starting headless desktop (noVNC)"
...
echo "[desktop/setup][INFO] ready"
echo "[desktop/setup][INFO] DISPLAY=${DISPLAY}"
echo "[desktop/setup][INFO] screenshot: import -display ${DISPLAY} -window root /tmp/agents-artifacts/${AGENTS_RUNNER_TASK_ID:-task}-desktop.png"
