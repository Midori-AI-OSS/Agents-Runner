...
class SettingsPage(QWidget, SettingsFormMixin):
    ...
    def _connect_autosave_signals(self) -> None:
        ...
        self._github_poll_interval_s.textChanged.connect(self._queue_debounced_autosave)
        self._github_poll_interval_s.textChanged.connect(self._refresh_github_poll_rate_warning)
        self._github_requests_per_second.textChanged.connect(self._queue_debounced_autosave)
        self._github_pr_retry_interval_minutes.textChanged.connect(self._queue_debounced_autosave)
        self._github_pr_retry_max_minutes.textChanged.connect(self._queue_debounced_autosave)
