...
from agents_runner.ui.artifacts.file_watcher import ArtifactFileWatcher
...
class ArtifactsTab(QWidget):
    ...
    def _load_thumbnail(self, artifact: ArtifactMeta) -> None:
        ...
        self._preview_loader.load_encrypted_thumbnail(
            artifact, self._current_task.task_id, self._current_task.environment_id
        )
