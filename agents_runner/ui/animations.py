...
from PySide6.QtCore import QEasingCurve, QParallelAnimationGroup, QPropertyAnimation, QSequentialAnimationGroup, Qt
...
def cross_fade(hide_widget: QWidget, show_widget: QWidget, duration: int = AnimationPresets.DURATION_NORMAL) -> QParallelAnimationGroup:
...
def slide_fade_in(widget: QWidget, direction: str = "up", duration: int = AnimationPresets.DURATION_NORMAL, distance: int = 30) -> QParallelAnimationGroup:
...
def staggered_fade_in(widgets: list[QWidget], base_duration: int = AnimationPresets.DURATION_NORMAL, stagger_delay: int = 50) -> QParallelAnimationGroup:
