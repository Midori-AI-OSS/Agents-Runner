...
- A summary of the change and why it was needed.

## Files changed

- Short list of important files or areas touched.
...
- [ ] Audit completed: 
    ...
    - Prompt Used: Specify the exact prompt and the Auditor sub-agent and model used (e.g. "Auditor with GPT-5.2 on High Reasoning")
- [ ] Evidence (one-line log or confirmation the agent printed):
