...
## Completion Note
Completed successfully. Created `agents_runner/agent_systems/` package with:
- `models.py`: All Pydantic models (PromptDeliverySpec, CapabilitySpec, UiThemeSpec, MountSpec, ExecSpec, AgentSystemContext, AgentSystemRequest, AgentSystemPlan, AgentSystemPlugin)
- `registry.py`: Plugin discovery and registration with safe error handling
- `__init__.py`: Package initialization with exports
All code passes ruff format and ruff check. No Qt imports. Commit: a7637b3
