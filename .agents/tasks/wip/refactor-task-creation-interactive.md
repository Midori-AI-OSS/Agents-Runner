# Refactor Interactive Task Creation to Use workspace_type

## Objective
Update interactive task creation to use `workspace_type` instead of `gh_management_mode`.
...
- Interactive tasks have correct workspace type based on their environment
- Task behavior matches environment workspace type
- Manual testing: Create interactive task in each workspace type environment
